...
class DeveloperPreview {
    ...
    let stat1 = StatisticModel(title: "ارزش بازار", value: "دو قرون", percentageChange: 1200)
    let stat2 = StatisticModel(title: "حجم بازار", value: "۱۲۲۱۳۲۹۱۸۸۷۹۱ قرون")
    let stat3 = StatisticModel(title: "کل داریی", value: "312312$", percentageChange: -12.65)
